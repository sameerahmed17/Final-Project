...
import { Avatar, Box, Button, Card, TextField, Modal, Typography, } from "@mui/material";
    ...
    <Box>
      <Box className="p-3 border-black rounded-2 d-flex flex-column gap-2 bg-white">
        ...
        <Box className="d-flex flex-wrap justify-content-evenly">
          <Button
            color="black"
            startIcon={<VideoCallIcon sx={{ color: "green" }} />}
          >
            Video
          </Button>
          <Button
            color="black"
            startIcon={<PhotoCameraIcon sx={{ color: "blue" }} />}
          >
            Photo
          </Button>
          <Button
            color="black"
            startIcon={<ArticleIcon sx={{ color: "orange" }} />}
          >
            {" "}
            article
          </Button>
      ...
      {postData.map((post) => (
        <Card key={post.id} className="mb-3 p-3 rounded-3">
          ...
          {post.image && (
            <img src={post.image} alt="Post" className=" w-100 rounded-2" />
          )}
